    ...
    <section>
      <div className="py-[70px]">
        <div className="container">
          ...
          <div>
            <ul className="flex flex-wrap xl:justify-between justify-center text-sm font-medium text-center gap-1 xl:gap-5 md:gap-1 md:mx-auto ">
              {tabInfo.map((tab, index) => (
                <li
                  key={index}
                  className={`relative overflow-hidden inline-block lg:w-[180px] w-[140px] xl:w-[220px] xl:py-4 py-2 xl:text-[20px] lg:text-[14px] text-[12px] font-normal font-rubik text-white  cursor-pointer xl:my-[10px] my-[10px]   ${
                    activeTab === index
                    ...
                    {tabContents[activeTab].map((item, index) => (
                      ...
                      >
                        <div className="overlay relative">
                          ...
                          />
                          <div className="bg-fuchsia-900/70 h-full w-full absolute left-[50%] top-[50%] translate-x-[-50%] group-hover:translate-y-[-132px] translate-y-[132px] flex items-center justify-center ">
                            <Image
                              src={PlayIcon}
                              alt="Play-icon"
                              className="brightness-200 invert-0"
                            />
                          </div>
                        </div>
                      </Link>
