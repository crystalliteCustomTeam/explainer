                    ...
                    <div className="grid grid-cols-12">
                        <div className="col-span-12 lg:col-span-7">
                            <div className="lg:py-[70px] xl:py-[120px] relative z-50">
                                ...
                                <p className='text-[13px] sm:text-[16px] font-sans leading-[20px] mb-3 text-white'>At Explainer Videos LLC, our adept animators specializing in video production have played a pivotal role in propelling numerous multinational firms to success. As a vanguard in the dominion of animated explainer video production, we distinguish ourselves by crafting animated videos of superior quality that engage and astonish your audience. Our team at Explainer Videos LLC is propelled by a zealous commitment to forging not only exceptionally creative but also intellectually invigorating custom explainer videos, thereby ensuring your enterprise is thrust into the limelight it rightfully commands.</p>
