...
const StoryLine = ({ content }) => {
    ...
    return (
        <>
            <section className={`w-full flex items-center justify-start py-6 md:py-12 lg:py-16 ${main} bg-#fbfbfb`}>
                <div className="container">
                    ...
                    <div className={`flex flex-col lg:flex-row items-center gap-y-8 justify-between mt-7 sm:mt-12 ${row}`}>
                        ...
                        <div className="w-full md:w-[100%]">
                            <Image src={AnimationOne} alt='Explainer Videos LLC' width={550} height={550} className="m-auto" />
                        </div>
                    </div>
                </div>
            </section>
