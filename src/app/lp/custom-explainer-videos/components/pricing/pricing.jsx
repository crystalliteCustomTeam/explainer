        ...
        <section className={styles.pricingSection} >
            <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto">
                <div className="m-auto text-center pb-5">
                    ...
                    <p>Providing exceptional pricing with amazing custom explainer video packages.<br className="hidden md:block" /> Choose a fantastic 2D, 3D & whiteboard explainer video package below to best suit your<br className="hidden md:block" /> business and budget. Boost your business with ny animation studio now.</p>
                </div>
