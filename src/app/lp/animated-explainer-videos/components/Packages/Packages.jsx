                ...
                <div className="grid grid-cols-12 gap-5">
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        <div className='bg-gradient-to-r from-[#f3d86e] to-[#FFCC00] rounded-[30px] md:rounded-[40px] lg:rounded-[25px] group'>
                            <div className="image overflow-hidden rounded-t-[10px] lg:rounded-t-[20px]">
                                <Image src={card1} alt='Explainer Videos LLC' className='w-full h-full object-cover lg:group-hover:translate-x-[-100px] ease-in-out group-hover:duration-1000 duration-1000 translate-x-0 lg:max-w-[500px] lg:min-w-[500px] lg:min-h-[150px] lg:max-h-[150px] xl:min-h-[200px] xl:max-h-[200px]' />
                            </div>
                            ...
                            <div className='px-5 pb-2'>
                                ...
                                <h5 className='text-[50px] xl:text-[70px] font-bold poppins text-center leading-[60px] xl:leading-[85px] mb-2 text-black'>$155<span className='font-semibold text-[16px] xl:text-[20px] line-through'>$499</span></h5>
                                <ul className='pb-4'>
                                ...
                                <div className="flex flex-wrap gap-y-3 items-center justify-between mt-[20px] mb-[10px] xl:px-2">
                                    <a href="tel:1-833-666-6684" className='text-left m-0 text-[14px] leading-[20px] montserrat flex justify-center items-center gap-x-2 font-normal'>
                                        <FaPhoneVolume className='rotate-[-45deg] text-black mt-1' />
                                        <span className='text-[#231f20] text-[16px] pt-2'>
                                            1-833-666-6684
                                        </span>
                                    </a>
                                    <a onClick={handleChatOpen} className='text-left m-0 leading-[20px] montserrat flex flex-col justify-center font-normal'>
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        <div className='bg-gradient-to-r from-[#003262] to-[#005DB8] rounded-[30px] md:rounded-[40px] lg:rounded-[25px] overflow-hidden group shadow-sm lg:scale-[1.04]'>
                            <div className="image overflow-hidden rounded-t-[10px] lg:rounded-t-[20px]">
                                <Image src={card2} alt='Explainer Videos LLC' className='w-full h-full lg:group-hover:translate-x-[-100px] ease-in-out group-hover:duration-1000 duration-1000 translate-x-0 lg:max-w-[500px] lg:min-w-[500px] lg:min-h-[150px] lg:max-h-[150px] xl:min-h-[200px] xl:max-h-[200px]' />
                            </div>
                            ...
                            <div className='px-5 pb-2'>
                                ...
                                <p className='text-center text-[13px] xl:text-[15px] font-medium leading-[24px] xl:leading-[30px] poppins text-white'>Whiteboard or Motion Graphics Animation</p>
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        <div className='bg-gradient-to-r from-[#C55F61] to-[#A70A0E] rounded-[30px] md:rounded-[40px] lg:rounded-[25px] group'>
                            <div className="image overflow-hidden rounded-t-[10px] lg:rounded-t-[20px]">
                                <Image src={card3} alt='Explainer Videos LLC' className='w-full h-full lg:group-hover:translate-x-[-100px] ease-in-out group-hover:duration-1000 duration-1000 translate-x-0 lg:max-w-[500px] lg:min-w-[500px] lg:min-h-[150px] lg:max-h-[150px] xl:min-h-[200px] xl:max-h-[200px]' />
                            </div>
