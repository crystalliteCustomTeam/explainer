    ...
    return (
        <>
            <section className='flex items-center justify-center mt-40 mb-20'>
                <h1 className='text-black text-5xl font-bold text-center font-sans'>Privacy Policies</h1>
            </section>
            <section className='mb-20'>
                <div className='container'>
                    <h3 className='text-black text-3xl font-bold font-sans mb-3'>What information do we gather?</h3>
                    <p className='text-black text-[16px] text-justify font-sans leading-[25px] mb-7'>
                        Explainer Videos LLC has set this privacy plan to explain our policies regarding customer’s personal data that is collected for our use. When you place a query online, you will only need to give some basic information to us by filling out a simple query form so that we could contact you to discuss the need. You will only need to enter your name, e-mail address, phone number or country.
                    </p>
                    <h3 className='text-black text-3xl font-bold font-sans mb-3'>What do we use your information for?</h3>
                    <p className='text-black text-[16px] text-justify font-sans leading-[25px] mb-4'>
                        Explainer Videos LLC uses the personal data for handling orders. Explainer Videos LLC and its members also use your personal data and other personally non-identifiable information that will help us in handling your orders properly and to better respond to your complexity. Furthermore, your information may be used for the following ways:
                    </p>
                    <ol className='mb-7'>
                        <li className='text-black text-[16px] text-justify font-sans leading-[25px] mb-1'>
                    ...
                    <h3 className='text-black text-3xl font-bold font-sans mb-3'>How do we protect your information?</h3>
                    <p className='text-black text-[16px] text-justify font-sans leading-[25px] mb-7'>
                        Explainer Videos LLC uses a secure server for the purpose of securing your private information. All your private/credit information sends out via Secure Socket Layer (SSL) technology that is used to keep the information confidential when you place your order online.
                    </p>
                    <h3 className='text-black text-3xl font-bold font-sans mb-3'>Do we use Cookie?</h3>
                    <p className='text-black text-[16px] text-justify font-sans leading-[25px] mb-7'>
                    ...
                    <h3 className='text-black text-3xl font-bold font-sans mb-3'>Do we disclose any information to outside parties?</h3>
                    <p className='text-black text-[16px] text-justify font-sans leading-[25px] mb-7'>
                    ...
                    <h3 className='text-black text-3xl font-bold font-sans mb-3'>The General Data Protection Regulation Imply</h3>
